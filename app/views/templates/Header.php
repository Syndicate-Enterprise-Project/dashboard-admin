...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>/css/font.css" crossorigin="anonymous">
<<<<<<< HEAD
    <link rel="icon" type="image/x-icon" href="<?= BASEURL; ?>/img/logo website.png" style="width: 100%; height: 50%;"/>
