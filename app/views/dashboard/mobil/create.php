...
<div class="d-flex flex-column w-100 mx-4">
    ...
    <div class="col-lg-8">
        <form action="<?= BASEURL; ?>/dashboard/create" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div class="mb-3">
                <label for="category" class="form-label">Tipe</label>
                <select class="form-select" name="category_id">
                    <?php foreach ($data['categories'] as $category) : ?>
                        <option value="<?= $category['id']; ?>"><?= $category['name']; ?></option>
                    <?php endforeach; ?>
            ...
            <div class="mb-3">
                <label for="title" class="form-label">Mesin</label>
                <input type="text" class="form-control " id="title" name="title" required autofocus>
            </div>
            <div class="mb-3">
                <label for="category" class="form-label">Transmisi</label>
                <select class="form-select" name="category_id">
                    <?php foreach ($data['categories'] as $category) : ?>
                        <option value="<?= $category['id']; ?>"><?= $category['name']; ?></option>
                    <?php endforeach; ?>
            ...
            <div class="mb-3">
                <label for="title" class="form-label">Tenaga</label>
                <input type="text" class="form-control " id="title" name="title" required autofocus>
            </div>
            <div class="mb-3">
                <label for="category" class="form-label">Penggerak</label>
                <select class="form-select" name="category_id">
                    <?php foreach ($data['categories'] as $category) : ?>
                        <option value="<?= $category['id']; ?>"><?= $category['name']; ?></option>
                    <?php endforeach; ?>
            ...
            <div class="mb-3">
                <label for="title" class="form-label">Warna</label>
                <input type="text" class="form-control " id="title" name="title" required autofocus>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="category" class="form-label">Bahan Bakar</label>
                <select class="form-select" name="category_id">
                    <?php foreach ($data['categories'] as $category) : ?>
                        <option value="<?= $category['id']; ?>"><?= $category['name']; ?></option>
                    <?php endforeach; ?>
