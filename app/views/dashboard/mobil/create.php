...
<script>
    ...
    function previewImageInt() {
        ...
        const imgPreview = document.querySelector('.img-previewInt');
    ...
    function previewImageEks() {
        const image = document.querySelector('#imageEks');
        const imgPreview = document.querySelector('.img-previewEks');
