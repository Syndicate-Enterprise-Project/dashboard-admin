...
<<<<<<< HEAD
                ...
                <div class="nav_list">
                    <a href="<?= BASEURL; ?>/dashboard" class="nav_link active" style="text-decoration: none;">
                        <i class='bx bx-grid-alt nav_icon'></i>
                        <span class="nav_name">Beranda</span>
                    </a>
                    <a href="<?= BASEURL; ?>/blog" class="nav_link" style="text-decoration: none;">
                        <i class='bx bx-news nav_icon'></i>
                        <span class="nav_name">Blog</span>
                    </a>
                    <a href="<?= BASEURL; ?>/mobil" class="nav_link" style="text-decoration: none;">
                        <i class='bx bx-car nav_icon'></i>
                        <span class="nav_name">Mobil</span>
                    </a>
                    <a href="<?= BASEURL; ?>/galeri" class="nav_link" style="text-decoration: none;">
                        <i class='bx bx-folder nav_icon'></i>
                        <span class="nav_name">Galeri</span>
                    </a>
                    <a href="<?= BASEURL; ?>/account/account" class="nav_link" style="text-decoration: none;">
                        <i class='bx bx-user nav_icon'></i>
                        <span class="nav_name">Akun</span>
                    </a>
                    <a href="<?= BASEURL; ?>/login/signout" class="nav_link tombol-logout" data-pesan="Ingin Logout" style="text-decoration: none; margin-top:10rem; ">
